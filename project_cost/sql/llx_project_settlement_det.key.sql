...
ALTER TABLE llx_project_settlement_det ADD INDEX idx_project_settlement_det_rowid (rowid);
--ALTER TABLE llx_project_settlement_line ADD INDEX idx_project_settlement_ref (ref);
