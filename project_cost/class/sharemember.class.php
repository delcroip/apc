...
/**
 *  \file       dev/projectcostsharemembers/projectcostsharemember.class.php
 ...
 */
class Projectcostsharemember extends CommonObject
{
    /**
     * @var string ID to identify managed object
     */				//!< To return several error codes (or messages)
    public $element='projectcostsharemember';			//!< Id that identify managed objects
    /**
     * @var string Name of table without prefix where object is stored
     */    
    public $table_element='project_cost_share_member';		//!< Name of table without prefix where object is stored
    ...
    function getNomUrl($htmlcontent,$id=0,$ref='',$withpicto=0)
    {
        ...
        if($id){
            $lien = '<a href="'.dol_buildpath('/project_cost/sharemember_card.php').'?id='.$id.'&action=view">';
        }else if (!empty($ref)){
            $lien = '<a href="'.dol_buildpath('/project_cost/sharemember_card.php').'?ref='.$ref.'&action=view">';
        }else{
            $lien =  "";
        }
        $lienfin=empty($lien)?'':'</a>';

    	$picto='share@project_cost';
...
// Commit or rollback
    ...
    function createFromClone($fromid)
    {
        global $user,$langs;
        $error=0;
        $object=new Projectcostsharemember($this->db);
        $this->db->begin();
        // Load source object
        $object->fetch($fromid);
        $object->id=0;
