...
/**
 * \file    project_cost/admin/about.php
 * \ingroup project_cost
 * \brief   About page of module project_cost.
 */
...
dol_fiche_head($head, 'about', '', 0, 'project_cost@project_cost');

dol_include_once('/project_cost/core/modules/modproject_cost.class.php');
$tmpmodule = new modproject_cost($db);
