.fmps-- Copyright (C) 2018     Patrick DELCROIX     <pmpdelcroix@gmail.com>
--
...
ALTER TABLE llx_project_cost_settlement ADD INDEX idx_project_cost_settlement_rowid (rowid);
ALTER TABLE llx_project_cost_settlement ADD INDEX idx_project_cost_settlement_ref (ref);
